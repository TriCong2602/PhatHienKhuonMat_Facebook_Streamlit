...
# Tạo thanh select để chọn tính năng
option = st.sidebar.selectbox(
    'Chọn tính năng',
    ('Chọn tính năng','Phát hiện khuôn mặt','Nhận dạng khuôn mặt',)
)
...
if option == 'Nhận dạng khuôn mặt':
    ...
    mydict = ['BanCong', 'BanDuc', 'BanDuong', 'BanGiang', 'BanHau', 'BanLinh', 'BanTien', 'ThayDuc']
